          ...
          <div className="col-6 d-flex">
            ...
            <div className="card-body px-3 text-start">
              ...
              <p className="card-text">
                ...
                People use them, every day, whether they're discussing ideas for
                new projects, deciding on the best solution for a customer's
                problem, or interviewing candidates. It's just one of the things
                that makes Shopping Cart peculiar.{" "}
                <Link href="/" className="text-decoration-none">
                  Learn more about Leadership Principles of Shopping Cart
                </Link>
              </p>
            </div>
          </div>
